...
private slots:
    ...
    void readSerialData(); // Slot for reading serial data
    ...
    void on_supplier_pushButton2_clicked();
    ...
    void on_employee_pushButton2_2_clicked();

    void on_pushButton_26_clicked();

    void on_pushButton_44_clicked();

    void on_supplier_pushButton2_2_clicked();

    void on_customer_pushButton2_2_clicked();

    void on_customer_pushButton_12_clicked();

    void on_delivery_pushButton_12_clicked();

    void on_stock_pushButton_12_clicked();

    void on_supplier_pushButton_12_clicked();

    void on_delivery_pushButton2_2_clicked();

    void on_stock_pushButton2_2_clicked();

    void on_pushButton_56_clicked();

    void on_stock_pushButton_9_clicked();

    void on_supplier_pushButton_9_clicked();

    void on_stock_pushButton_10_clicked();

    void on_stock_pushButton_11_clicked();

    void on_supplier_pushButton_11_clicked();

    void on_customer_pushButton_15_clicked();

    void on_stock_pushButton_15_clicked();

    void on_supplier_pushButton_15_clicked();

    void on_delivery_pushButton_14_clicked();

    void on_stock_pushButton_14_clicked();

    void on_supplier_pushButton_14_clicked();
