...
void MainWindow::on_pushButton_Login_clicked()
{
    ...
    if (conn.createconnect()) { // Call the static method to create the connection
        ...
        if (query.exec() && query.next()) {
            ...
            ui->welcomeLabel_5->setText("Welcome, " + fullName);
            ...
            ui->welcomeLabel_8->setText("Welcome, " + fullName);
            ui->welcomeLabel_7->setText("Welcome, " + fullName);
            ui->welcomeLabel_10->setText("Welcome, " + fullName);
            ui->welcomeLabel_6->setText("Welcome, " + fullName);
...
void MainWindow::on_trier_2_clicked() {
    QString GA_sortParam = ui->comboBox_trie_2->currentText(); // Get the selected sort parameter

    QSqlQueryModel *sortedModel = new QSqlQueryModel();

    if (GA_sortParam == "nom") {
        sortedModel->setQuery("SELECT * FROM CLIENTS ORDER BY nom ASC");
    } else if (GA_sortParam == "id") {
        sortedModel->setQuery("SELECT * FROM CLIENTS ORDER BY id ASC");
    } else if (GA_sortParam == "adresse") {
        sortedModel->setQuery("SELECT * FROM CLIENTS ORDER BY adresse ASC");
    }

    ui->affichage_2->setModel(sortedModel);
}
...
void MainWindow::on_pushButton_pdf_clicked()
{
    ...
    QString pdfFilePath = "C:/Users/MSI GP76/OneDrive - ESPRIT/Bureau/ibri" + name_string + "_" + id_string + ".pdf";
...
void MainWindow::on_employee_pushButton2_2_clicked()
{
    ui->Home->setCurrentIndex(1);
}
...
void MainWindow::on_supplier_pushButton2_2_clicked()
{
     ui->Home->setCurrentIndex(8);
}


void MainWindow::on_customer_pushButton2_2_clicked()
{
    ui->Home->setCurrentIndex(4);
}


void MainWindow::on_customer_pushButton_12_clicked()
{
     ui->Home->setCurrentIndex(4);
}


void MainWindow::on_delivery_pushButton_12_clicked()
{
    ui->Home->setCurrentIndex(6);
}


void MainWindow::on_stock_pushButton_12_clicked()
{
    ui->Home->setCurrentIndex(7);
}


void MainWindow::on_supplier_pushButton_12_clicked()
{
    ui->Home->setCurrentIndex(8);
}


void MainWindow::on_delivery_pushButton2_2_clicked()
{
    ui->Home->setCurrentIndex(6);
}


void MainWindow::on_stock_pushButton2_2_clicked()
{
    ui->Home->setCurrentIndex(7);
}
//arduino ibri zouari
...
void MainWindow::on_stock_pushButton_9_clicked()
{
    ui->Home->setCurrentIndex(7);
}


void MainWindow::on_supplier_pushButton_9_clicked()
{
    ui->Home->setCurrentIndex(8);
}


void MainWindow::on_stock_pushButton_10_clicked()
{
    ui->Home->setCurrentIndex(7);
}


void MainWindow::on_stock_pushButton_11_clicked()
{
    ui->Home->setCurrentIndex(7);
}


void MainWindow::on_supplier_pushButton_11_clicked()
{
    ui->Home->setCurrentIndex(8);
}


void MainWindow::on_customer_pushButton_15_clicked()
{
    ui->Home->setCurrentIndex(4);
}


void MainWindow::on_stock_pushButton_15_clicked()
{
    ui->Home->setCurrentIndex(7);
}


void MainWindow::on_supplier_pushButton_15_clicked()
{
    ui->Home->setCurrentIndex(8);
}


void MainWindow::on_delivery_pushButton_14_clicked()
{
    ui->Home->setCurrentIndex(6);
}


void MainWindow::on_stock_pushButton_14_clicked()
{
    ui->Home->setCurrentIndex(7);
}


void MainWindow::on_supplier_pushButton_14_clicked()
{
    ui->Home->setCurrentIndex(8);
}
